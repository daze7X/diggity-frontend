                            ...
                            <div className="bg-white dark:bg-glass-bg border border-glass-border shadow-xl rounded-3xl p-6 space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        <Link scroll={false} href={`/products/${main}/${sub}?${buildQuery({ filter: null as any, page: '1' })}`} className={`px-4 py-2 text-sm font-bold rounded-xl transition-colors ${!filter ? 'bg-brand-blue text-white' : 'bg-glass-bg text-text-gray hover:bg-glass-border'}`}>All Products</Link>
                                        <Link scroll={false} href={`/products/${main}/${sub}?${buildQuery({ filter: 'free', page: '1' })}`} className={`px-4 py-2 text-sm font-bold rounded-xl transition-colors ${filter === 'free' ? 'bg-brand-blue text-white' : 'bg-glass-bg text-text-gray hover:bg-glass-border'}`}>Free</Link>
                                        <Link scroll={false} href={`/products/${main}/${sub}?${buildQuery({ filter: 'paid', page: '1' })}`} className={`px-4 py-2 text-sm font-bold rounded-xl transition-colors ${filter === 'paid' ? 'bg-brand-blue text-white' : 'bg-glass-bg text-text-gray hover:bg-glass-border'}`}>Paid</Link>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        <Link scroll={false} href={`/products/${main}/${sub}?${buildQuery({ sort: 'latest', page: '1' })}`} className={`px-4 py-2 text-sm font-bold rounded-xl transition-colors ${(!sort || sort === 'latest') ? 'bg-brand-blue/10 text-brand-blue' : 'text-text-gray hover:bg-glass-bg'}`}>Latest</Link>
                                        <Link scroll={false} href={`/products/${main}/${sub}?${buildQuery({ sort: 'oldest', page: '1' })}`} className={`px-4 py-2 text-sm font-bold rounded-xl transition-colors ${sort === 'oldest' ? 'bg-brand-blue/10 text-brand-blue' : 'text-text-gray hover:bg-glass-bg'}`}>Oldest</Link>
                                        <Link scroll={false} href={`/products/${main}/${sub}?${buildQuery({ sort: 'popular', page: '1' })}`} className={`px-4 py-2 text-sm font-bold rounded-xl transition-colors ${sort === 'popular' ? 'bg-brand-blue/10 text-brand-blue' : 'text-text-gray hover:bg-glass-bg'}`}>Most Popular</Link>
                                        <Link scroll={false} href={`/products/${main}/${sub}?${buildQuery({ sort: 'price_asc', page: '1' })}`} className={`px-4 py-2 text-sm font-bold rounded-xl transition-colors ${sort === 'price_asc' ? 'bg-brand-blue/10 text-brand-blue' : 'text-text-gray hover:bg-glass-bg'}`}>Price: Low to High</Link>
                                        <Link scroll={false} href={`/products/${main}/${sub}?${buildQuery({ sort: 'price_desc', page: '1' })}`} className={`px-4 py-2 text-sm font-bold rounded-xl transition-colors ${sort === 'price_desc' ? 'bg-brand-blue/10 text-brand-blue' : 'text-text-gray hover:bg-glass-bg'}`}>Price: High to Low</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
